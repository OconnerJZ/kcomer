...
const Pedidos = () => {
  ...
  const { cart, addToCart, removeFromCart, clearBusiness, getCartCount, getGrandTotal } = useCart();
      ...
      <Box sx={{ maxWidth: 900, mx: 'auto', mt: { xs: 2, sm: 4 }, px: 2 }}>
              ...
              <Tab
                ...
                label={
                  <Stack direction="row" spacing={1} alignItems="center">
                    ...
                    <span>{cart[businessId].businessName}</span>
                    <Chip
        ...
        <Paper sx={{ p: 3, borderRadius: 2 }}>
          <Stack
            ...
            sx={{ mb: 2 }}
          >
            <Typography variant="h6">{currentBusiness.businessName}</Typography>
            <IconButton
              color="error"
              onClick={() => {
              ...
              >
                <Box sx={{ width: '100%', display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                  ...
                  <IconButton
                    edge="end"
                    color="error"
                    onClick={() => removeFromCart(currentBusinessId, itemId)}
                ...
                >
                  <Stack direction="row" spacing={1} alignItems="center">
                    ...
                    >
                      <IconButton
                        size="small"
                        onClick={() => handleQuantityChange(currentBusinessId, item, -1)}
                      >
