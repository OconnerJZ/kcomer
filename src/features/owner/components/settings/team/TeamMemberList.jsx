...
export default function TeamMemberList({ members = [], onRoleChange, onRemove }) {
  return <Box sx={{ overflow: "hidden" }}>
    <Box sx={{ py: 1.5 }}><Typography fontWeight={800}>Miembros activos</Typography><Typography variant="caption" color="text.secondary">{members.length} personas</Typography></Box><Divider />
