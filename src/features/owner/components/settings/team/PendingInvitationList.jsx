...
export default function PendingInvitationList({ invitations = [], onCancel }) {
  ...
  return <Box sx={{ py: 2, borderTop: "1px solid", borderBottom: "1px solid", borderColor: "divider" }}><Typography fontWeight={600} sx={{ mb: 1.5 }}>Invitaciones pendientes</Typography><Stack spacing={1}>
