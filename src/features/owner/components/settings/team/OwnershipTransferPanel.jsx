...
export default function OwnershipTransferPanel({ email, retainPrevious, loading, onEmailChange, onRetainChange, onTransfer }) {
  return <Box sx={{ p: { xs: 1.5, sm: 2 }, borderLeft: "4px solid", borderColor: "warning.main", bgcolor: "rgba(242,140,40,.07)", borderRadius: "0 12px 12px 0" }}><Stack spacing={2}>
    <Stack direction="row" spacing={1} alignItems="center"><SwapHoriz color="warning" /><Box><Typography fontWeight={600}>Traspasar el local</Typography><Typography variant="caption" color="text.secondary">Requiere aceptación de la otra persona. Hasta entonces sigues siendo owner principal.</Typography></Box></Stack>
