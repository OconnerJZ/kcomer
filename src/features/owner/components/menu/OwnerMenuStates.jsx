  ...
  <Box sx={{ pb: { xs: 2, sm: 2.5 }, mb: 2.5, borderBottom: "1px solid", borderColor: "divider" }}>
    <Stack direction={{ xs: "column", sm: "row" }} justifyContent="space-between" alignItems={{ xs: "stretch", sm: "center" }} gap={2}>
      <Box>
        ...
        <Typography variant="h5" sx={{ fontWeight: 600, letterSpacing: "-0.02em" }}>Tu catálogo, simple y vivo</Typography>
      ...
      <Button variant="contained" startIcon={<Add />} onClick={onCreate} disableElevation sx={{ textTransform: "none", borderRadius: "8px", px: 2.25, py: 1 }}>
        Agregar platillo
      </Button>
    </Stack>
  </Box>
...
export const EmptyMenuState = ({ onCreate }) => (
  <Paper elevation={0} sx={{ p: 5, textAlign: "center", border: "1px dashed", borderColor: "divider", borderRadius: "8px" }}>
    ...
    <Button variant="contained" startIcon={<Add />} onClick={onCreate} disableElevation sx={{ textTransform: "none", borderRadius: "8px" }}>Agregar platillo</Button>
  </Paper>
);

export const EmptyMenuResults = () => (
  <Paper elevation={0} sx={{ p: 4, textAlign: "center", border: "1px solid", borderColor: "divider", borderRadius: "8px" }}>
